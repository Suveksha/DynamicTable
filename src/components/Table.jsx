...
export default function Table()
{
    ...
    const {setOpenModal, setOpenToggleList, openToggleList}=useContext(TableContext)
...
[])
    return (
        ...
        <div onClick={()=>toggleCheckBox('table')}>
            ...
            </thead>
           {
            userData.map((user)=>(
                <tr className="border-1 border-slate-100 border-2">
                    ...
                    <td className="px-2">{user.birthDate}</td>
                    <td className="px-2">{user.age}</td>
                    <td className="px-2">{user.weight}</td>
                    <td className="px-2">{user.university}</td>
                </tr>
            ))
           }
        </table>
